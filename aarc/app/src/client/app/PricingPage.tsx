...
export const tiers = [
  {
    ...
    features: ['Try out our tools', 'Basic support'],
  },
  {
    name: 'Pro Plan',
    id: TierIds.PRO,
    ...
    features: ['Covered Call Strike Selector', 'Option Scenarios'],
    bestDeal: true,
  },
  {
    name: 'Ultimate Plan',
    ...
    features: ['All Investment Tools', 'Porfolio Optimisation', 'Earnings Scenarios'],
  },
];
            ...
            >
              ...
              <div className='mb-8'>
                <div className='flex items-center gap-x-4'>
                  <h3 id={tier.id} className='text-gray-900 text-3xl font-bold leading-8 dark:text-white'>
                    {tier.name}
                  </h3>
                </div>
              ...
              {!!user && !!user.subscriptionStatus ? (
                <button
                  ...
                  className={cn(
                    'mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-yellow-400',
                    {
